    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">Liste des imprimantes</h3>
            </div>
                ...
                <table id="datatable-buttons" class="table table-striped table-bordered">
                    ...
                    <?php foreach ($printers as $printer) { ?>
                        <tr>
                            ...
                            <td><?php echo $printer->date_creation; ?></td>
                            <td><?php echo $printer->contact; ?></td>
                            <td><?php echo $printer->serial; ?></td>
                            
                            <td class="actions" style="width: 1%; text-align: center; white-space: nowrap">
                                <a href="#" class="on-default btn_edit" id='<?php echo $printer->id; ?>'><i class="fa fa-pencil"></i></a>&nbsp;
                                <a href="#" class="on-default btn_delete" id='<?php echo $printer->id; ?>'><i class="fa fa-trash-o" style="color:red"></i></a>&nbsp;
                            </td>
                        </tr>
                    <?php } ?>
                    </tbody>
